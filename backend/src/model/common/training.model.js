...
export const listTrainingPrograms = async (companyId) => {
  return supabase
    ...
    .select('id, company_id, name, description, category, is_mandatory, created_by_employee_id, created_at, updated_at')
...
export const listTrainingAssignments = async ({ employeeId, companyId }) => {
  return supabase
    ...
    .select(`
      ...
      completed_at,
      completion_status,
      training_programs!inner(id, name, description, category, is_mandatory)
    `)
...
export const listCompanyTrainingAssignments = async (companyId) => {
  return supabase
    ...
    .select(`
      ...
      training_programs!inner(id, name, description, category)
    `)
...
export const createTrainingAssignmentRecord = async (payload) => {
  return supabase
    .from('training_assignments')
    .insert(payload)
    .select('id, employee_id, training_program_id, assigned_at, due_date, completed_at, completion_status')
    .single()
}
